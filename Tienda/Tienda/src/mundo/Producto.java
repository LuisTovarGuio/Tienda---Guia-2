...
public class Producto {
    ...
    public void cambiarRutaImagen(String nuevaRutaImagen) {
        ...
        if (nuevaRutaImagen != null && !nuevaRutaImagen.isEmpty()) {
            rutaImagen = nuevaRutaImagen;
        } else {
            
            System.out.println("La nueva ruta de la imagen es inválida.");
        }
    }
    ...
    public double calcularPrecioFinal() {
    	if (tipo=="papeleria") {
    		return ((valorUnitario*0.16)+valorUnitario);
    	}if (tipo=="drogueria") {
    		return ((valorUnitario*0.12)+valorUnitario);
    	}if (tipo=="supermercado") {
    		return ((valorUnitario*0.04)+valorUnitario);
    	}
